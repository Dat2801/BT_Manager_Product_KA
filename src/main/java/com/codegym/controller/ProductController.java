...
//
    @GetMapping("")
    public ModelAndView showPage(@PageableDefault(size = 5) Pageable pageable) {
        ModelAndView modelAndView = new ModelAndView("list");
...
//        }
    ...
    public ModelAndView showTop5Price() {
        ModelAndView modelAndView = new ModelAndView("top5price");
        modelAndView.addObject("products", productService.findTop5Price());
        return modelAndView;
    }
    @GetMapping("/top5New")
    public ModelAndView showTop5New() {
        ModelAndView modelAndView = new ModelAndView("top5new");
        modelAndView.addObject("productTop5", productService.findTop5New());
        return modelAndView;
    }
